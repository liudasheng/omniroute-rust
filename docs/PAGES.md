...
|---|---|---|---|
| `/home` | Home | done | standalone Home sidebar item, quick-start, 2fr/1fr provider topology + recent-request layout, 3s refresh; provider nodes open editable detail |
